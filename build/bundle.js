...
exports.fetchCurrentUser = exports.fetchUsers = exports.FETCH_USERS = undefined;
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _axios2.default.get('https://react-ssr-api.herokuapp.com/current_user');
  ...
  _createClass(UsersList, [{
    ...
    value: function renderUsers() {
      ...
      return this.props.users.map(function (user) {
        return _react2.default.createElement(
          'li',
          { key: user.id, 'class': 'hello', onClick: function onClick() {
              return _this2.processLink;
            } },
          user.name
        );
      });
